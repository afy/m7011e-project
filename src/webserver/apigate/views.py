...
def handle_product_crud(request, id):
    match(request.method):
        case    "GET": response = api_gateway_client.call("prod", "get-product", {"id": id}, None, None)
        case   "POST": response = api_gateway_client.call("prod", "update-product", {"id": id, "post-data": request.data}, None, None)
        case    "PUT": response = api_gateway_client.call("prod", "create-product", {"id":id, "put-data": request.data}, None, None)
        case "DELETE": response = api_gateway_client.call("prod", "delete-product", {"product_id":id}, None, None)
...
def handle_user_crud(request, id):
    ...
    #response = api_gateway_client.call("auth", "create-user", {"test":1}, None)
    return JsonResponse(response)